      ...
      <div className="main-container">
        <div className="container">
          ...
          <div className="jumbotron">
            <h1 className="text-center"><strong>The New York Times</strong></h1>
            <h2 className="text-center">Search for and save articles.</h2>
          </div>
          ...
          <footer>
            ...
            <p className="pull-right">
              ...
              Proudly mined by Heather Foxhill, Built with React.
            </p>
          </footer>
        </div>
      </div>
